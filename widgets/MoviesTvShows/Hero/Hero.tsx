            ...
            <div className='relative z-20'>
                <div className='flex flex-col items-center gap-5 -mt-55 lg:gap-6 2xl:gap-7.5'>
                    <div className='flex flex-col items-center gap-3.5 text-center'>
                        ...
                        <p className='hidden text-neutral-500 text-sm md:block lg:text-base font-medium 2xl:text-lg'>CinemaStreamBox
                    ...
                    <div className='flex flex-col gap-5 md:flex-row'>
                        ...
                        <div className='flex justify-center items-center gap-2.5'>
                            <div
                                className='bg-neutral-950 flex items-center justify-center w-12 h-12 p-3 rounded-md 2xl:w-14 2xl:h-14'>
                                <Plus/></div>
                            <div
                                className='bg-neutral-950 flex items-center justify-center  w-12 h-12 p-3 rounded-md 2xl:w-14 2xl:h-14'>
                                <ThumbsUp/></div>
