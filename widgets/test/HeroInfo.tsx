...
export const HeroInfo: FC<Props> = ({className, movie}) => {
            ...
            {imageUrl &&
                <div className="absolute inset-0 z-20 flex items-end pb-10">
                    <div className="my-container w-full flex flex-col items-center gap-5 lg:gap-6 2xl:gap-7.5 text-center">
                        ...
                        <p className="hidden text-neutral-400 text-sm md:block lg:text-base font-medium 2xl:text-lg max-w-2xl mx-auto">{movie?.overview}</p>
